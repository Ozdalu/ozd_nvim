...
vim.keymap.set("n", "<leader>hu", function() vim.cmd.HarpoonNavigate(2) end, { desc = "Go to Harpoon file 2"})
vim.keymap.set("n", "<leader>hi", function() vim.cmd.HarpoonNavigate(3) end, { desc = "Go to Harpoon file 3"})
vim.keymap.set("n", "<leader>ho", function() vim.cmd.HarpoonNavigate(4) end, { desc = "Go to Harpoon file 4"})
vim.keymap.set("n", "<leader>hj", function() vim.cmd.HarpoonNavigate(5) end, { desc = "Go to Harpoon file 5"})
vim.keymap.set("n", "<leader>hk", function() vim.cmd.HarpoonNavigate(6) end, { desc = "Go to Harpoon file 6"})
vim.keymap.set("n", "<leader>hl", function() vim.cmd.HarpoonNavigate(7) end, { desc = "Go to Harpoon file 7"})
